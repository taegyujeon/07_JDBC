...
public class JDBCExample2 {
	public static void main(String[] args) {
		...
		try {
			...
			/* 2-1) Oracle JDBC Driver 객체를 메모이레 적재 */
			Class.forName("oracle.jdbc.driver.OracleDriver");
			
			/* 2-2) 연결 정보를 이용해서 Connection 생성 */
			...
			String sql = "SELECT EMP_ID , EMP_NAME , SALARY , JOB_NAME " // 다음줄 넘어갈때 띄어쓰기 
					+ "FROM EMPLOYEE "
